...
import br.com.gntech.gestaovagas.modules.candidate.usecases.ApplyJobCandidateUseCase;
...
public class CandidateController {
  ...
  @Autowired
  public CandidateController(CreateCandidateUseCase createCandidateUseCase, ProfileCandidateUseCase profileCandidateUseCase, ListAllJobsByFilterUseCase jobsByFilterUseCase, ApplyJobCandidateUseCase applyJobCandidateUseCase) {
  ...
  @PreAuthorize("hasRole('CANDIDATE')")
  @SecurityRequirement(name = "jwt_auth")
  @Operation(summary = "Inscrição para vaga", description = "Essa funcao e responsavel por realizar a inscrição em uma vaga especifica.")
  public ResponseEntity<Object> applyJob(HttpServletRequest request, @RequestBody UUID idJob) {
    try {
      Object idCandidate = request.getAttribute("candidate_id");
      ApplyJob applyJob = applyJobCandidateUseCase.execute(UUID.fromString(idCandidate.toString()), idJob);
